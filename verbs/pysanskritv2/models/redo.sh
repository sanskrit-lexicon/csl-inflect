...
rm calc_models_*.txt
# 4 special tenses for all clases in  active and middle voices
python3 root_model.py 5,present ../inputs/verb_cp.txt,../inputs/verb_cp_extra.txt ../manual/tables_present.txt calc_models_present.txt

# passive of 4 special tenses for all classes
#python3 root_model.py 2 ../inputs/verb_cp.txt calc_models_2.txt
python3 root_model.py 5,passive ../inputs/verb_cp.txt,../inputs/verb_cp_extra.txt ../manual/tables_passive.txt calc_models_passive.txt

#python3 root_model.py 3,fut ../inputs/verb_cp.txt calc_models_fut.txt
python3 root_model.py 5,fut ../inputs/verb_cp.txt,../inputs/verb_cp_extra.txt ../manual/tables_fut.txt calc_models_fut.txt

#python3 root_model.py 3,pft ../inputs/verb_cp.txt calc_models_pft.txt
python3 root_model.py 5,pft ../inputs/verb_cp.txt,../inputs/verb_cp_extra.txt ../manual/tables_pft.txt calc_models_pft.txt

#python3 root_model.py 3,con ../inputs/verb_cp.txt calc_models_con.txt
python3 root_model.py 5,con ../inputs/verb_cp.txt,../inputs/verb_cp_extra.txt ../manual/tables_con.txt calc_models_con.txt

#python3 root_model.py 3,ben ../inputs/verb_cp_deshpande_330.txt calc_models_ben.txt
python3 root_model.py 5,ben ../inputs/verb_cp.txt,../inputs/verb_cp_extra.txt ../manual/tables_ben.txt calc_models_ben.txt

# injunctive (aorist without augment)
python3 root_model.py 5,inj ../inputs/verb_cp.txt,../inputs/verb_cp_extra.txt ../manual/tables_inj.txt calc_models_inj.txt
